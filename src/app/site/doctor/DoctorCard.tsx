    ...
    <>
      ...
      >
        <div className="w-full aspect-square relative">
          ...
          />
          <div className="absolute top-0 right-0 p-4 space-y-2 flex flex-col items-end bg-gradient-to-r from-transparent to-neutral-900/40 rounded-xl">
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="mx-auto w-full max-w-md rounded-xl bg-white p-6 space-y-4 shadow-xl overflow-y-auto max-h-[90vh]">
            ...
            <div className="flex items-center gap-4 mt-4">
              {props.whatsapp && (
                <a href={`https://wa.me/${props.whatsapp}`} target="_blank" rel="noopener noreferrer">
                  <BsWhatsapp className="text-green-600 w-6 h-6" />
                </a>
              )}
              {props.facebook && (
